...
export default function Logo({ width, height = 39, className }: LogoProps) {
  // SVG原始宽高比 1013:395
  const aspectRatio = 1013 / 395;
  
  // 如果只提供了height，根据宽高比计算width
  // 如果只提供了width，根据宽高比计算height
  // 如果都没提供，使用默认值
